...
class _TransactionCompletedScreenState
  ...
  Widget build(BuildContext context) {
    final customerName =
        _paymentData?['customerName'] ??
        AuthStateService.instance.currentUser?.displayName ??
        'Customer';
    final customerEmail =
        _paymentData?['customerEmail'] ??
        AuthStateService.instance.currentUser?.email ??
        '';
    final gatewayMsg =
        _paymentData?['iciciMessage'] ??
        _paymentData?['status'] ??
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDetailRow(
                              'REF NO.',
                              _paymentData?['merchantTxnNo'] ??
                                  widget.transactionId.replaceAll('TXN', ''),
                            ),
                            _buildDetailRow(
                              'AMOUNT PAID',
                              '₹ ${widget.amountPaid}',
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (widget.isFirstTimeRegistration) {
                              // For new users: Proceed to branding customization
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                                      BrandingCustomizationScreen(
                              ...
                              // For existing users: Redirect directly to Admin Dashboard
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
